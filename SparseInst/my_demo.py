...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="/workspace/python/other/SparseInst/configs/sparse_inst_r50_giam.yaml",
        metavar="FILE",
    ...
    parser.add_argument(
        ...
        default=["MODEL.WEIGHTS", "/workspace/python/other/SparseInst/sparse_inst_r50_giam_aug_2b7d68.pth", "INPUT.MIN_SIZE_TEST", "512"],
